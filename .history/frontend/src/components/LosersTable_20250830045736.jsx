  ...
  if (loading && data.length === 0) {
    return (
      <div className="text-center py-8">
        <div className="animate-pulse text-pink num-font">Loading losers...</div>
      </div>
    );
  }
              ...
              >
                ...
                <div className="relative z-10 grid grid-cols-[minmax(0,1fr)_152px_108px_28px] gap-x-4 items-start">
                  ...
                  <div className="flex items-center gap-3 sm:gap-4 min-w-0">
                    <div className="flex items-center justify-center w-8 h-8 rounded-full bg-pink/30 text-pink font-bold text-sm shrink-0 num-font">{r.rank}</div>
                  ...
                  <div className="w-[152px] pr-6 text-right">
                    <div className="text-base sm:text-lg md:text-xl font-bold text-teal num-font leading-none whitespace-nowrap">
                      {Number.isFinite(r.price) ? formatPrice(r.price) : 'N/A'}
                    </div>
                    <div className="text-sm leading-tight text-gray-300 num-font whitespace-nowrap">
                  ...
                  <div className="w-[108px] pr-1.5 text-right align-top">
                    <div className={`text-base sm:text-lg md:text-xl font-bold num-font leading-none whitespace-nowrap ${r.change3m < 0 ? 'text-pink' : 'text-[#C026D3]'}`}>
