...
export const WebSocketProvider = ({ children }) => {
  ...
  const poll = async () => {
      ...
      try {
        const gainersData = await fetchData(API_ENDPOINTS.gainersTable1Min, { signal: currentController.signal });
        ...
        inFlight = false;
        currentController = null; // Clear after use
      }
    };
